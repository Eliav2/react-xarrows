...
import XarrowMainNew, { XarrowMainNewProps } from "react-xarrows/src/components/XarrowMainNew";
import { Xwrapper, useXarrow } from "packages/react-xarrows/src";
import { Xwrapper as XwrapperV2, default as XarrowV2, useXarrow as useXarrowV2 } from "react-xarrow-v2";
  ...
  return (
    <div>
      <Xwrapper>
        ...
        >
          <DraggableBox id={"box1"} dragGrid={[10, 10]} initialOffset={{ x: 420, y: 150 }} />
          <DraggableBox id={"box2"} dragGrid={[10, 10]} initialOffset={{ x: 500, y: 200 }} />
          <XarrowMainNew start={"box1"} end={"box2"} {...args} divContainerProps={{ ref: divRef, style: {} }} headShape={"circle"} />
        </div>
      </Xwrapper>
    </div>
  );
