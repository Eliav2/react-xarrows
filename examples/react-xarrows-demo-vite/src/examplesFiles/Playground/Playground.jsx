...
const PlayGround = () => {
  ...
  return (
    <div>
      ...
      <p>
        you can drag and drop shpaes from the left toolbox menu. you can select any shape and then topbar will apear with some options.
        <br />
        <strong>
      ...
      <Xwrapper>
        <div className="canvasStyle" id="canvas" onClick={() => handleSelect(null)}>
          <div className="toolboxMenu">
            ...
            <div className="toolboxContainer">
              {shapes.map((shapeName) => (
                <div key={shapeName} className={shapeName} onDragStart={(e) => e.dataTransfer.setData("shape", shapeName)} draggable>
                  {shapeName}
          ...
          <div className="interfacesBarStyle" onDragOver={(e) => e.preventDefault()} onDrop={handleDropStatic} id="interfacesInputsBar">
          ...
          <div id="boxesContainer" className="boxesContainer" onDragOver={(e) => e.preventDefault()} onDrop={handleDropDynamic}>
            <TopBar {...props} />
          ...
          <div className="interfacesBarStyle" onDragOver={(e) => e.preventDefault()} onDrop={handleDropStatic} id="interfacesOutputsBar">
          ...
          {/* xarrow connections*/}
          {lines.map((line, i) => (
            <Xarrow key={line.props.root + "-" + line.props.endPoint + i} line={line} selected={selected} setSelected={setSelected} />
          ))}
          {/* boxes menu that may be opened */}
          {lines.map((line, i) =>
            line.menuWindowOpened ? (
              <MenuWindow key={line.props.root + "-" + line.props.endPoint + i} setLines={setLines} line={line} />
            ) : null
          )}
        </div>
      </Xwrapper>
