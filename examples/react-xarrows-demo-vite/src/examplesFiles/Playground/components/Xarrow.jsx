...
export default ({ setSelected, selected, line: { props } }) => {
  ...
  const defProps = {
    passProps: {
      ...
      onClick: (e) => {
        ...
        setSelected({
          id: { startPoint: props.root, endPoint: props.endPoint },
          type: "arrow",
        });
      },
      cursor: "pointer",
  ...
  if (selected && selected.type === "arrow" && selected.id.root === props.root && selected.id.endPoint === props.endPoint) color = "red";
