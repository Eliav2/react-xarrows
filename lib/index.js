...
const Xarrow = (props) => {
    let { startAnchor, endAnchor, label, color, lineColor, headColor, strokeWidth, showHead, headSize, showTail, tailColor, tailSize, path, curveness, dashness, headOffset, tailOffset, passProps, SVGcanvasProps, arrowBodyProps, arrowHeadProps, arrowTailProps, divContainerProps, SVGcanvasStyle, divContainerStyle, _extendSVGcanvas, _debug, _cpx1Offset, _cpy1Offset, _cpx2Offset, _cpy2Offset } = props, extraProps = __rest(props, ["startAnchor", "endAnchor", "label", "color", "lineColor", "headColor", "strokeWidth", "showHead", "headSize", "showTail", "tailColor", "tailSize", "path", "curveness", "dashness", "headOffset", "tailOffset", "passProps", "SVGcanvasProps", "arrowBodyProps", "arrowHeadProps", "arrowTailProps", "divContainerProps", "SVGcanvasStyle", "divContainerStyle", "_extendSVGcanvas", "_debug", "_cpx1Offset", "_cpy1Offset", "_cpx2Offset", "_cpy2Offset"]);
    ...
    const updatePosition = (positions) => {
        ...
        let startPoints = anchors_1.prepareAnchorLines(startAnchor, sPos);
        let endPoints = anchors_1.prepareAnchorLines(endAnchor, ePos);
        // choose the smallest path for 2 points from these possibilities.
        let { startPointObj, endPointObj } = anchors_1.getShortestLine(startPoints, endPoints);
    ...
    return (react_1.default.createElement("div", Object.assign({}, divContainerProps, { style: Object.assign({ position: "absolute" }, divContainerStyle) }, extraProps),
        react_1.default.createElement("svg", Object.assign({ ref: selfRef, width: st.cw, height: st.ch, style: Object.assign({ position: "absolute", left: st.cx0, top: st.cy0, pointerEvents: "none", border: _debug ? "1px dashed yellow" : null }, SVGcanvasStyle), overflow: "auto" }, SVGcanvasProps),
            ...
            showTail ? (react_1.default.createElement("path", Object.assign({ 
                // d={`M 0 0 L ${fTailSize} ${fTailSize / 2} L 0 ${fTailSize} L ${
                //   fTailSize / 4
                // } ${fTailSize / 2} z`}
                // d={factorDpathStr(normalArrowShape, fTailSize)}
                d: normalArrowShape, fill: tailColor, pointerEvents: "auto", transform: `translate(${xOffsetTail},${yOffsetTail}) rotate(${st.tailOrient}) scale(${fTailSize})` }, passProps, arrowTailProps))) : null,
            ...
            showHead ? (react_1.default.createElement("path", Object.assign({ 
                ...
                //   fHeadSize / 4
                // } ${fHeadSize / 2} z`}
                d: heartShape, fill: headColor, pointerEvents: "auto", transform: `translate(${xOffsetHead},${yOffsetHead}) rotate(${st.headOrient}) scale(${fHeadSize})` }, passProps, arrowHeadProps))) : null),
        ...
        _debug ? (react_1.default.createElement(react_1.default.Fragment, null, [...st.startPoints, ...st.endPoints].map((p, i) => {
...
Xarrow.propTypes = {
    ...
    headOffset: prop_types_1.default.number,
    tailOffset: prop_types_1.default.number,
