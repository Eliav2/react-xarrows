...
export class Vector {
  ...
  add<T extends Vector>(this: T, p: Vector | number): Vector {
    return operatorFunc(this, p, math_operators.add);
  }

  sub<T extends Vector>(this: T, p: Vector | number): Vector {
    return operatorFunc(this, p, math_operators.sub);
  }

  // mul(p: Vector | number) {
  mul<T extends Vector>(this: T, p: Vector | number): Vector {
    return operatorFunc(this, p, math_operators.mul);
  }

  dev<T extends Vector>(this: T, p: Vector | number): Vector {
    return operatorFunc(this, p, math_operators.dev);
  }
